...
| **Pre-Slice-1 P-1 — Turn worktree isolation OFF by default (closes I-064)** — done by making the orchestrator no longer *request* `isolation: worktree` (git-init kept as a gate, now for the I-083 progress commits); the `worktree.bgIsolation` via `configure.py` route was tried then reverted (wrong skill — see I-064 note) | Workshop demo readiness | `_Plan/workshop-readiness-2026-05-24.md:Pre-Slice-1 P-1` | `Plugins/Dataflow to Notebook Plugin/_Documentation/plugin_learnings.md` (N8) + `anthropics/claude-code` CHANGELOG.md v2.1.143 | Done (2026-05-30) |
...
| **Pre-Slice-1 P-3 — Restructure Stage 2 to parent-owned prepare/ask/write pattern (closes reopened I-063)** | Workshop demo readiness | `_Plan/workshop-readiness-2026-05-24.md:Pre-Slice-1 P-3` | `Plugins/Dataflow to Notebook Plugin/_Documentation/plugin_learnings.md` (N15) | Done (2026-05-30) |
